...
export default class Soil extends Component {
  render() {
    const { id, title, img, price, inCart } = this.props.soil;
    return (
        ...
        <SoilConsumer>
          {value => (
            <div className="card">
              ...
              >
                <Link to="/soils-details">
                  <img src={img} alt="soils" className="card-img-top" />
                </Link>
              </div>
              ...
              <div className=" card-footer d-flex justify-content-between">
                <p className="align-self-center mb-5">{title}</p>
